#Matrix inversion is usually a costly computation so it can be beneficial to cache the inverse of a matrix 
#and retrieve it instead of calculating every time on the fly
